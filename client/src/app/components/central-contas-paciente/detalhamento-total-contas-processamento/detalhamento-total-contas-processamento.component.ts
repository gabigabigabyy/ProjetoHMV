...
@Component({
  selector: 'app-detalhamento-total-contas-processamento',
  templateUrl: './detalhamento-total-contas-processamento.component.html',
  styleUrls: ['./detalhamento-total-contas-processamento.component.css'],
  providers: [
    ConverterDataPipe
  ]
})

export class DetalhamentoTotalContasProcessamentoComponent implements OnInit {
  ...
  private loadDataSource() {
    this.showLoading();
    this.service.getTotalContasProcessamento().subscribe(list => {
  ...
  getContas() {
    this.service.getTotalContasProcessamento().subscribe(contas => {
