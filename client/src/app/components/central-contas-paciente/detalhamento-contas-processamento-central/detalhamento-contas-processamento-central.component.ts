...
@Component({
  ...
  styleUrls: ['./detalhamento-contas-processamento-central.component.css'],
  providers: [
    ConverterDataPipe
  ]
})
export class DetalhamentoContasProcessamentoCentralComponent implements OnInit {
  ...
  constructor(private service: DetalhamentoContasProcessamentoCentralService,
    ...
    this.currentRoute = "/detalhamentoCentralContasPacientes/" + this.local;
